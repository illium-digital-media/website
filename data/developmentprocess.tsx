const developmentProcess = [
  ...
  },
  {
    ...
    keywords: ["Coding", "Demo"],
    description: "With design approvals, we transition to coding. Post-development, a demo link lets you experience the site's flow and features, ensuring it aligns with your expectations."
  },
  {
    title: "Polishing and Going Live",
    keywords: ["Fine-tuning", "Launch"],
    description: "After integrating your feedback, we fine-tune every aspect for peak performance. With analytics tools integrated, your site is ready for launch, presenting it to the world in all its glory."
  }
];
