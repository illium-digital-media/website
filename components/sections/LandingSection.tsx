...
const LandingSection: React.FC = () => {
  return (
    <section className="relative max-sm:px-4 flex items-center max-xl:px-5 w-full max-sm:h-[600px] max-lg:h-[800px] lg:h-screen">
      ...
      <div className="max-w-screen-xl m-auto w-full z-0 flex">
        <div className="text-white sm:w-10/12 lg:w-1/2">
